    ...
    return (
      <div  className={`h-screen bg-gray-800 text-white flex flex-col ${widthClass}`}>
        <div className="flex justify-end p-4">
          <button onClick={() => setCollapsed(!collapsed)} className="text-white hover:text-gray-300 focus:outline-none hover:cursor-pointer">
            ☰
          </button>
        </div>
        ...
        {!collapsed && <div className="p-4 text-gray-400 text-xs border-t border-gray-700">&copy; 2025 Drone Tracker</div>}
      </div>
    );
  };
